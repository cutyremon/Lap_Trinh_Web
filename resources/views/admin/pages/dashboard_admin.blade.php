                        ...
                        <div class="col-md-4">
                            ...
                            <div class="progress-group" v-for="prd in product">
                                ...
                                <div class="progress sm">
                                    <div v-if="prd.so_luong*100/sum>=50" class="progress-bar progress-bar-aqua"
                                       v-bind:style="{ width: prd.so_luong*100/sum +'%' }"></div>
                                       <div v-if="prd.so_luong*100/sum>=40 && prd.so_luong*100/sum<50"
                                           class="progress-bar progress-bar-red"
                                           v-bind:style="{ width: prd.so_luong*100/sum + '%' }"></div>
                                           <div v-if="prd.so_luong*100/sum>=30 && prd.so_luong*100/sum<40"
                                               class="progress-bar progress-bar-yellow"
                                               v-bind:style="{ width: prd.so_luong*100/sum + '%' }"></div>
                                               <div v-if="prd.so_luong*100/sum>=20 && prd.so_luong*100/sum<30"
                                                   class="progress-bar progress-bar-green"
                                                   v-bind:style="{ width: prd.so_luong*100/sum + '%' }"></div>
                                                   <div v-if="prd.so_luong*100/sum<20" class="progress-bar progress-bar-blue"
                                                   v-bind:style="{ width: prd.so_luong*100/sum + '%' }"></div>
                                               </div>
                                           </div>
                                       </div>
